...
use crate::session::compaction_config::{
    ...
    ContextPressure, ContextSessionKind, SUPPRESS_AUTH, SUPPRESS_NONE, SUPPRESS_STICKY,
    SUPPRESS_TURN, SUPPRESS_UNTIL_SUCCESS, transition_after_model_sample,
    transition_after_tool_batch_committed, transition_before_model_request,
};
